class Program
{
    ...
    static async Task<string> RequestTokenAsync()
    {
        try
        {
            ...
            var tokenEndpoint = "https://localhost:7264/connect/token"; // Your IdentityServer token endpoint
    ...
    static async Task AccessProtectedResourceAsync(string accessToken)
    {
        try
        {
            ...
            var apiEndpoint = "https://localhost:7264/api/WeatherForecast"; // Your protected API endpoint
